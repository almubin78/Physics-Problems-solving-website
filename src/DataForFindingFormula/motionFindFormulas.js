export const motionsFinderData = [
    ...
    { formula: 's = ut + 0.5 * a * t^2', required: ['u', 't', 'a'],exclude: ['v','s'], compute: (vals) => vals.u * vals.t + 0.5 * vals.a * vals.t ** 2 },
    ...
    { formula: 'v^2 = u^2 + 2as', required: ['u', 'a', 's'],exclude: ['v','t'], compute: (vals) => Math.sqrt(vals.u ** 2 + 2 * vals.a * vals.s) },
